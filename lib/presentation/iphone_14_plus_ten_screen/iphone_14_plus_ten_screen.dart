import 'bloc/iphone_14_plus_ten_bloc.dart';
import 'models/iphone_14_plus_ten_model.dart';
...
class Iphone14PlusTenScreen extends StatelessWidget {
  Iphone14PlusTenScreen({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<Iphone14PlusTenBloc>(
        create: (context) => Iphone14PlusTenBloc(Iphone14PlusTenState(
            iphone14PlusTenModelObj: Iphone14PlusTenModel()))
          ..add(Iphone14PlusTenInitialEvent()),
        child: Iphone14PlusTenScreen());
  }
                ...
                child: SizedBox(
                    ...
                    child: Stack(alignment: Alignment.center, children: [
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                          AssetImage(ImageConstant.imgGroup33),
                                      fit: BoxFit.cover)),
                      ...
                      Align(
                          ...
                          child: Container(
                              ...
                              decoration: AppDecoration
                                  .gradientLightBlueToLightBlueFb
                                  .copyWith(
                                      borderRadius:
                      ...
                      CustomImageView(
                          ...
                          margin: EdgeInsets.only(top: 48.v, right: 60.h)),
                      CustomImageView(
                          imagePath: ImageConstant.imgRectangle10,
                          height: 118.v,
                          width: 49.h,
                      ...
                      Align(
                          ...
                          child: Container(
                              ...
                              width: 100.adaptSize,
                              margin: EdgeInsets.only(left: 3.h, top: 20.v),
                              decoration: BoxDecoration(
                      ...
                      Align(
                          ...
                          child: Container(
                              height: 35.v,
                              width: 257.h,
                              margin: EdgeInsets.only(left: 78.h, top: 192.v),
                              padding: EdgeInsets.symmetric(
  ...
  Widget _buildName(BuildContext context) {
    return Padding(
        ...
        child: BlocSelector<Iphone14PlusTenBloc, Iphone14PlusTenState,
            ...
            builder: (context, nameController) {
              return CustomTextFormField(
                  ...
                  hintStyle: CustomTextStyles.bodyMediumOnError,
                  validator: (value) {
                    if (!isText(value)) {
              ...
              return CustomTextFormField(
                  ...
                  prefix: Container(
                      ...
                      child: CustomImageView(
                          ...
                          height: 13.v,
                          width: 15.h)),
                  prefixConstraints: BoxConstraints(maxHeight: 21.v),
                  validator: (value) {
                    if (value == null ||
  ...
  Widget _buildPassword(BuildContext context) {
    return Padding(
        ...
        child: BlocBuilder<Iphone14PlusTenBloc, Iphone14PlusTenState>(
          ...
          return CustomTextFormField(
              ...
              suffix: InkWell(
                  onTap: () {
                    context.read<Iphone14PlusTenBloc>().add(
                        ChangePasswordVisibilityEvent(
                            value: !state.isShowPassword));
                  },
                  child: Container(
                      margin:
                          EdgeInsets.only(left: 30.h, right: 1.h, bottom: 6.v),
                      child: CustomImageView(
  ...
  Widget _buildUpLoadYourPersonalPhoto(BuildContext context) {
    return CustomElevatedButton(
        ...
        decoration: CustomButtonStyles.gradientLightBlueToBlueGrayDecoration);
  }
  ...
  Widget _buildCreateAccount(BuildContext context) {
    return CustomOutlinedButton(
        ...
        margin: EdgeInsets.only(left: 16.h, right: 11.h),
  ...
  onTapClient(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.iphone14PlusEightScreen,
    );
  }

  /// Navigates to the iphone14PlusNineScreen when the action is triggered.
  onTapWorker(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.iphone14PlusNineScreen,
    );
  }
}
